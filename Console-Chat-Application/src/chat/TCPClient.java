	...
	public void run() {
		try {
			...
			while (true) {
				...
				if (command.equals(ConsoleChatConstants.ALL_COMMAND) == true) {
					All();
					continue;
				}
				if (command.equals(ConsoleChatConstants.MSG_COMMAND) == true) {
					Msg();
					continue;
				}
				if (command.equals(ConsoleChatConstants.NICK_COMMAND) == true) {
					Nick();
					continue;
				}
